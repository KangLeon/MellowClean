...
mkdir -p dist/MellowClean.app/Contents/MacOS dist/MellowClean.app/Contents/Resources dist/bin
...
cp Resources/AppIcon.icns dist/MellowClean.app/Contents/Resources/
